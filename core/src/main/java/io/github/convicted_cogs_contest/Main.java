...
public class Main extends Game {
    ...
    public void screenSwitch() {
        ...
        //if the user is on the fight screen and on of the characters reaches 0 hit point display the win screen
            ...
            if (Gdx.input.isButtonPressed(Input.Buttons.LEFT)&& Gdx.input.getX() > 1000 && Gdx.input.getX() < 1250 && Gdx.input.getY() < 630 && Gdx.input.getY() > 580 && getScreen() instanceof WinScreen ) {
                screen = 3;
                win = false;
                this.setScreen(gameScreen);
            }
